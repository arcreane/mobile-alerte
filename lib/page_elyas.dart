      ...
      home: Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            elevation: 0,
            backgroundColor: Colors.transparent,
            title: Text('Liste des tâches',style: TextStyle(color: Colors.black, fontSize: 22.0, fontWeight: FontWeight.w600),),
            centerTitle: true,
            leading: IconButton(
                icon: Icon(
                 ...
                 children: <Widget>[
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: FlatButton(
                        child: Text('afficher les listes', style: TextStyle(fontSize: 22),textAlign: TextAlign.center ),
                        onPressed: () => {
                          Navigator.push( context,
